...
var defaultSysVars = []*SysVar{
	...
	{ScopeGlobal | ScopeSession, TiDBEnableIndexAdvisor, BoolToIntStr(DefTiDBUseIndexAdvisor)},
	{ScopeGlobal | ScopeSession, TiDBEnableIndexAdvisorTest, BoolToIntStr(DefTiDBUseIndexAdvisorTest)},
